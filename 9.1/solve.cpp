 ...
 *       to initially have enough space to accommodate the values of v2 as well).
 */
	...
	for (size_t n1 = 0; n1 <= max_size; ++n1)
	{
		for (size_t n2 = 0; n2 <= max_size; ++n2)
		{
			for (int i = 0; i < 1000; ++i)
			{
				...
				std::vector< int > values;
				std::merge(v1.begin(), v1.end(), v2.begin(), v2.end(), std::back_inserter(values));
			...
			std::cout << "passed random tests for arrays of sizes " << n1 << " and " << n2 << std::endl;
		}
	}
